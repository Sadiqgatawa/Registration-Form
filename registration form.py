...
Label(root,text="Registration Form", font= " arial 25 ").pack(padx="50",pady="50")
...
Button(root,text="Register", font=20, width=11, height=2,command=registered).place(x=250,y=380)
